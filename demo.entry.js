...
/******/ 	var hotCurrentHash = "5831c355dffb886169d1"; // eslint-disable-line no-unused-vars
		...
		_createClass(Calendar, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement('input', { className: 'react-as-calendar-ipt', placeholder: this.props.placeholder, name: this.props.name, value: (0, _util.timeFormat)(this.state.value, this.props.format), onFocus: this._handleFocus }),
