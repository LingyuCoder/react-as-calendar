...
/******/ 	var hotCurrentHash = "de1e5c20eaa9936cf58b"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libCalendar = __webpack_require__(226);

	var _libCalendar2 = _interopRequireDefault(_libCalendar);

	__webpack_require__(246);

	exports['default'] = _libCalendar2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAsDatepicker = __webpack_require__(234);

	var _reactAsDatepicker2 = _interopRequireDefault(_reactAsDatepicker);
	...
	var Calendar = (function (_React$Component) {
		function Calendar(props) {
			...
			var today = (0, _util.date2obj)(new Date());
			var value = (0, _util.toDate)(props.value);
			var objValue = (0, _util.date2obj)(value);
			this.state = {
		...
		_createClass(Calendar, [{
			...
			value: function componentWillReceiveProps(nextProps) {
				...
				nextProps.year && (newState.year = (0, _util.toDate)(nextProps.year));
				nextProps.month && (newState.month = (0, _util.toDate)(nextProps.month));
				nextProps.showPanel && (newState.showPanel = (0, _util.toDate)(nextProps.showPanel));
				this.setState(newState);
			}
		}, {
			key: 'getValue',
			value: function getValue() {
				return (0, _util.timeFormat)(this.state.value, this.props.format);
			}
		}, {
			key: 'setValue',
			...
			value: function componentDidMount() {
				...
				document.body.addEventListener('click', this._gcb = function (e) {
					if (!container.contains(e.target)) {
						_this.setState({
							showPanel: false
						});
						_this.fireAll('panelHide', _this);
					}
				}, false);
			}
		}, {
			...
			value: function _handleDateChange(year, month) {
				this.setState({
					year: year,
					month: month
				});
			...
			key: '_handleIptKeyDown',
			value: function _handleIptKeyDown(e) {
			...
			value: function render() {
				return _react2['default'].createElement(
					'span',
					{ className: 'react-as-calendar' },
					_react2['default'].createElement('input', { className: 'react-as-calendar-ipt', onKeyDown: this._handleIptKeyDown, placeholder: this.props.placeholder, name: this.props.name, value: (0, _util.timeFormat)(this.state.value, this.props.format), onFocus: this._handleFocus }),
					this.state.showPanel && _react2['default'].createElement(
						'div',
						{ className: 'panel' },
						_react2['default'].createElement(_reactAsDatepicker2['default'], {
			...
			value: {
				...
				showPanel: _react2['default'].PropTypes.bool,
				format: _react2['default'].PropTypes.string,
				blacklist: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.object),
				name: _react2['default'].PropTypes.string,
				placeholder: _react2['default'].PropTypes.string,
				autoHidePanel: _react2['default'].PropTypes.bool,
				onChange: _react2['default'].PropTypes.func,
				onPanelShow: _react2['default'].PropTypes.func,
				onPanelHide: _react2['default'].PropTypes.func,
	...
	(0, _reactMixin2['default'])(Calendar.prototype, _reactAsEventMixin2['default']);

	exports['default'] = Calendar;
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); if (true) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(229), foundReactClasses = false; if (makeExportsHot(module, __webpack_require__(59))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Calendar.jsx" + ": " + err.message); } }); } } })(); }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(240)();
	exports.push([module.id, ".react-as-calendar {\n  position: relative;\n}\n.react-as-calendar .react-as-calendar-ipt {\n  padding: 0 30px 0 10px;\n  outline: 0;\n  height: 30px;\n  border: 1px solid #ccc;\n  background: #ffffff url(\"//img.alicdn.com/tps/i4/TB189XuHpXXXXa7aXXXZ0bbGpXX-36-34.png\") no-repeat 126px 9px;\n  background-size: 24px 22px;\n  background-position: center right;\n  vertical-align: middle;\n}\n.react-as-calendar .panel {\n  position: absolute;\n  width: 228px;\n  background: #fff;\n}\n", ""]);
